...
def detect_portal(*, listing_url: str, html: str | None, text_content: str | None = None) -> PortalDetection:
    ...
    if "myworkdayjobs.com" in hostname or "workday" in hostname or "workday" in combined:
        return PortalDetection(
    ...
    if "greenhouse.io" in hostname or "greenhouse" in combined:
        return PortalDetection(
            ...
            reasons=["Greenhouse-style public job board signature detected."],
            page_title=_page_title(html_value),
            content_fingerprint=fingerprint,
        )
    ...
    if "ashbyhq.com" in hostname or "ashby" in combined:
        return PortalDetection(
